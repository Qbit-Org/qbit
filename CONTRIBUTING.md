...
repository. Its public URL is launch-owned and still TBD, so this document
keeps the reference generic until that URL is finalized.
...
- The final public launch hash is TBD until a qbit launch announcement freezes
  it.
...
Do not file security-sensitive qbit reports in public issues or send them to
Bitcoin Core contacts. Use the qbit security channel announced on
https://qbit.org once it is published.
