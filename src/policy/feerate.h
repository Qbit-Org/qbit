...
#ifndef QBIT_POLICY_FEERATE_H
#define QBIT_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "QBT"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BTC_KVB,      //!< Use base-unit/kvB fee rate unit
