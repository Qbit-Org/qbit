...
#ifndef QBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define QBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // QBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
