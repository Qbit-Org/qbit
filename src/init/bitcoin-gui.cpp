...
public:
    ...
    // qbit-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // qbit-node accepts the option, and qbit-gui accepts all qbit-node
