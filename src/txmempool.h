...
#ifndef QBIT_TXMEMPOOL_H
#define QBIT_TXMEMPOOL_H
...
protected:
    ...
    uint64_t totalTxSize GUARDED_BY(cs){0};      //!< sum of all mempool txs' virtual sizes; qbit does not discount witness data.
