...
#ifndef QBIT_INTERFACES_NODE_H
#define QBIT_INTERFACES_NODE_H
...
//! Top-level interface for a qbit node (qbitd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or qbit.conf.
