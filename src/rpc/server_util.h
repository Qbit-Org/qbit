...
#ifndef QBIT_RPC_SERVER_UTIL_H
#define QBIT_RPC_SERVER_UTIL_H
...
/**
 * Return an empty permissionless/native block index on top of the tip, with
 * height, time and nBits set.
 */
void NextEmptyBlockIndex(CBlockIndex& tip, const Consensus::Params& consensusParams, CBlockIndex& next_index);

#endif // QBIT_RPC_SERVER_UTIL_H
