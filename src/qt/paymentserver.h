...
#ifndef QBIT_QT_PAYMENTSERVER_H
#define QBIT_QT_PAYMENTSERVER_H
...
extern const QString QBIT_IPC_PREFIX;
extern const QString LEGACY_BITCOIN_IPC_PREFIX;
