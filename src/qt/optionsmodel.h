...
#ifndef QBIT_QT_OPTIONSMODEL_H
#define QBIT_QT_OPTIONSMODEL_H
...
public:
    ...
    QbitUnit getDisplayUnit() const { return m_display_qbit_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(QbitUnit unit);
