...
BOOST_AUTO_TEST_CASE(test_FormatSubVersion)
{
    ...
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", CLIENT_VERSION, std::vector<std::string>()), "/Test:0.1.2/");
...
BOOST_AUTO_TEST_CASE(test_CompareSubVersion)
{
    ...
    BOOST_CHECK_EQUAL(CompareSubVersion("/qbit:0.1.2/", "/qbit:0.1.1/", "qbit").value(), 1);
