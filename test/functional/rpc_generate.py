...
class RPCGenerateTest(BitcoinTestFramework):
    ...
    def test_generatetoaddress(self):
        self.generatetoaddress(self.nodes[0], 1, MiniWallet(self.nodes[0]).get_address())
    ...
    def test_generateblock(self):
        ...
        combo_desc = node.getdescriptorinfo('combo(' + combo_key + ')')['descriptor']
        combo_addresses = node.deriveaddresses(combo_desc)
        ...
        # Ensure coins are mature enough to spend
        ...
        ranged_descriptor = 'pkh(qrpbSRJj3eCrXD2z4pcgc3u9JyzYaU8NvFBiAofLPyjf5J6hReRKQnTRkRdjcgpRKVNGk884VebuF3yxqeZGGd3JvMgtbRFZP5Eremu8Unc1nT2/0/*)'
        ...
        child_descriptor = 'pkh(qrpbSRJj3eCrXD2z4pcgc3u9JyzYaU8NvFBiAofLPyjf5J6hReRKQnTRkRdjcgpRKVNGk884VebuF3yxqeZGGd3JvMgtbRFZP5Eremu8Unc1nT2/0\'/0)'
