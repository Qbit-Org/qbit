...
class GetBlockFromPeerTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        chain_pruneheight = pruned_node.getblockchaininfo()["pruneheight"]
        # The RPC return value can lag the chain pruneheight by one block.
        assert chain_pruneheight >= pruneheight
        assert chain_pruneheight - pruneheight <= 1
