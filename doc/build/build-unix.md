UNIX BUILD NOTES
====================
Some notes on how to build qbit in Unix.
...
memory available when compiling qbit. On systems with less, gcc can be
...
To build qbit without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
See [dependencies.md](/doc/build/dependencies.md) for a complete overview, and
[depends](/depends/README.md) on how to compile them yourself, if you wish to
not use the packages of your Linux distribution.

Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, qbit can
