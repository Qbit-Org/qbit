...
The qbit daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in qbit requires the ZeroMQ API >= 4.0.0
[libzmq](https://github.com/zeromq/libzmq/releases).
For version information, see [dependencies.md](/doc/build/dependencies.md).
...
For instance:
    ...
    $ qbitd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/qbitd.tx.raw \
...
From the perspective of qbitd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into qbitd directly. Furthermore, no information is
