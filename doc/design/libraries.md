...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *qbit-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *qbit-qt* and *qbit-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *qbit-node* and *qbit-gui* executables to communicate when [`-DENABLE_IPC=ON`](/doc/integration/multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *qbitd* and *qbit-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *qbitd* and *qbit-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *qbit-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](/doc/integration/zmq.md) functionality used by *qbitd* and *qbit-qt* executables. |
...
qbit-cli[qbit-cli]-->libbitcoin_cli;

qbitd[qbitd]-->libbitcoin_node;
qbitd[qbitd]-->libbitcoin_wallet;

qbit-qt[qbit-qt]-->libbitcoin_node;
qbit-qt[qbit-qt]-->libbitcoinqt;
qbit-qt[qbit-qt]-->libbitcoin_wallet;

qbit-wallet[qbit-wallet]-->libbitcoin_wallet;
qbit-wallet[qbit-wallet]-->libbitcoin_wallet_tool;
...
class qbit-qt,qbitd,qbit-cli,qbit-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different qbit applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
