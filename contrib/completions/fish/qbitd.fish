...
complete --command qbitd --no-files

# Extract options
function __fish_qbitd_get_options
...
complete \
    --command qbitd \
    --arguments "(__fish_qbitd_get_options --nofiles)"
