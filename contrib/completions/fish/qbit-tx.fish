...
# Extract options
function __fish_qbit_tx_get_options
...
# Extract commands
function __fish_qbit_tx_get_commands
...
complete \
    --command qbit-tx \
    --condition "not __fish_qbit_seen_cmd (__fish_qbit_tx_get_commands --commandsonly)" \
    --arguments "(__fish_qbit_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command qbit-tx \
    --arguments "(__fish_qbit_tx_get_commands)" \
    --no-files
