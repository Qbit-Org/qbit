...
BITCOIND=${BITCOIND:-$BINDIR/qbitd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/qbit.conf}
...
then
  ...
  echo -e "To safely generate a qbit.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example qbit.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-qbit-conf.sh.
##
...
# parse the output from qbitd --help
